...
So I have got my django app running on Openshift. ([how to run django app on Openshift](/tech/2014-12-29-django-on-openshift/))
...
### 7. Add to the list of known hosts
